...
For PUN instructions see the PUN readme at: "ExternalPackages/Photon Unity Networking/readme.txt"

This demo requires a Virtual Reality headset to work properly. It supports HTC Vive (SteamVR) and Oculus Rift (OVR) as well as Cardboard (GoogleVR). Tested on Unity 5.5.0f3.
...
5) Build the game on your desired target platform.